...
const List = ({ children }: React.PropsWithChildren) => {
    ...
    const handleOnDragEnd = (event: DragEndEvent) => {
        ...
        const taskStageId = event.active.data.current?.stageId || null;
        console.log('Dragging from stage:', taskStageId);
        console.log('Dropping on stage:', stageId);
