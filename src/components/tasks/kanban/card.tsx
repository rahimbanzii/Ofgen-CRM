import CustomAavatar from '@/components/custom-avatar';
...
import { useNavigationButton } from '@refinedev/core/dist/hooks/button/navigation-button';
...
const ProjectCard = ({ id, title, updatedAt, dueDate, users }: ProjectCardProps) => {
            ...
            >
              {users.map((user) => (
                <Tooltip title={user.name} key={user.id}>
                  <CustomAavatar name={user.name} src={user.avatarUrl} />
                </Tooltip>
              ))}
            </Space>
          )}
